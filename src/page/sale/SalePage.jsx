...
const SalePage = () => {
  ...
  const handleDataFetch = useCallback(async (signal) => {
    try {
      ...
      setSaleTransactionData(filterSaleTransactions.data);
    } catch (error) {
  ...
  const formattedStock = useMemo(
    () => AvailableQuantity(saleTransactionData, data),
                    ...
                    .map((fieldName, colIndex) => (
                      <td key={colIndex}>
                        <input
                          ...
                          list={
                            getFieldName(colIndex) === "product_name"
                          ...
                          // readOnly={
                          //   ![0, 1, 3, 4].includes(colIndex) // Make fields read-only if not Barcode, Sale Price, or quantity
                          // }
                          // style={{
                          //   backgroundColor: ![0, 1, 4, 3].includes(colIndex)
                          //     ? "white"
                          ...
                          onChange={(e) => {
                            ...
                            console.log("d", updatedItems[fieldName]);
                              ...
                              const matchedProduct = [...data]
                                ...
                                .find(
                                  (product) =>
                                    ...
                                    product.ProductTrace.name === value
                                );
                          ...
                          <datalist id={`item_codes_${rowIndex}`}>
                            ...
                            {data.length > 0 && (
                              <>
                                {[
                                  ...new Set(
                                    data.map((item) => item.ProductTrace?.name)
                                  ),
            ...
            <div className="first_row_div_permanent_supplier_supershop">
              <div className="container_search_permanent_supplier_supershop">
                <div className="container_separate_permanent_supplier_supershop">
                  ...
                  <div className="save-and-delete-button-customer">
                  ...
                  {customerData &&
                    customerData.map((item, index) => (
                      <tr
                        ...
                        style={{ cursor: "pointer" }}
                        className={
                          activeSupplierRow === index ? "activeRow" : ""
                        }
